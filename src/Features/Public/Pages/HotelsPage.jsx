...
function HotelsPage() {
  // ----------------------------------------------------
  // ERROR FIX: All state and constants must be inside the component body
  // ----------------------------------------------------
  ...
  // Note: 'bookings' data is not used in this specific component's JSX, 
          ...
          <div className="bg-linear-to-r from-blue-600 to-blue-800 text-white p-8 rounded-lg shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input type="text" placeholder="Select dates" className="w-full p-3 rounded bg-white text-gray-800" />
              </div>
              <div>
